// start of frontend/components/ui/dialog.tsx
"use client"
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // [FIX] Enforce physical centering regardless of parent `dir`
    ...
    >
      {children}
      {/* [FIX] Position Close button on the LEFT (logical 'end' in RTL) */}
...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1.5 text-start", // RTL: text-start (Right)
      className
    )}
    {...props}
  />
...
// end of frontend/components/ui/dialog.tsx