...
export default function ShareLayout({
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#050505] font-sans" dir="rtl">
      {/* Main Content Area */}
      ...
      <footer className="sticky bottom-0 z-50 w-full border-t border-border bg-[#050505] backdrop-blur-md p-4">
